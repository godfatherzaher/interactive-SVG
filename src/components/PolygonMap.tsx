...
const PolygonMap: React.FC<PolygonMapProps> = ({ handleSelect }) => {
  return (
    <svg
    ...
    >
      <polygon
          ...
          <polygon
            ...
            onPointerEnter={() => handleSelect(10)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(11)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(12)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(13)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(14)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(15)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(16)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(17)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(18)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(19)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(20)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(21)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(22)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(23)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(24)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(25)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(26)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(27)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(28)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(29)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(30)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(31)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(32)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(33)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(34)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(35)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(36)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(37)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(38)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(39)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(40)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(41)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(42)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(43)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(44)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(45)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(46)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(47)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(48)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(49)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(50)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(51)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(52)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(53)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(54)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(55)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(56)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(57)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(58)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(59)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(60)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(61)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(62)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(63)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(64)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(65)}
          />
          <polygon
            ...
            onPointerEnter={() => handleSelect(66)}
          />
    </svg>
  );
};
